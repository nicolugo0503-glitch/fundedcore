        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-[.68rem] text-t3">{brief?.source === "openai" ? "Generated by AI · live" : "Composed from your data"} · {now.toLocaleDateString("en-US", { weekday: "short", month: "short", day: "numeric" })}</div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-[.68rem] text-t3">{tradeRead?.source === "openai" ? "AI strategist · from today's news & tape" : "From today's news & tape"}</div>
            </div>
          </div>
